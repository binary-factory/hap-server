...
function hex(hexString: string): BigNum {
    return new BigNum(hexString.replace(/\s/g, ''), 16);
}
...
export const SRPConfigurations: { [bits: number]: SRPConfiguration; } = {
    3072: {
        safePrime: hex(`FFFFFFFF FFFFFFFF C90FDAA2 2168C234 C4C6628B 80DC1CD1 29024E08 8A67CC74
